...
const LINK_STYLE =
  'px-4 py-2 text-sm font-normal text-neutral-500 flex items-center justify-center hover:text-neutral-950 transition-colors';
    ...
    <div className="fixed top-0 left-0 z-50 flex w-full items-center justify-between border-b border-neutral-200 bg-white/90 p-4 backdrop-blur-[6px]">
      <div className="flex items-center gap-8">
        ...
        <ul className="flex items-center">
          <li className={cn(LINK_STYLE, pathname === '/playground' && 'text-neutral-950')}>
            <Link to="/playground">Playground</Link>
          </li>
          <li className={cn(LINK_STYLE, pathname === '/chatlog' && 'text-neutral-950')}>
            <Link to="/chatlog">Chatlog</Link>
          </li>
          <li className={cn(LINK_STYLE, pathname === '/subscription' && 'text-neutral-950')}>
